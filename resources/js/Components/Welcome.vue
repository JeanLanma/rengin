    ...
    <div>
        ...
        <div class="flex justify-center py-8">
            ...
            <div class="container mx-auto pr-4">
                <div class="w-72 bg-white dark:bg-gray-900 max-w-xs mx-auto rounded-sm overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-100 cursor-pointer">
                    <div class="h-20 bg-blue-500 flex items-center justify-between">
                        <p class="mr-0 text-white text-lg pl-5">Habitaciones disponibles</p>
                    </div>
                    <div class="flex justify-between px-5 pt-6 mb-2 text-sm dark:text-gray-300 text-gray-600">
                        <p>TOTAL</p>
                    </div>
                    <p class="py-4 text-3xl ml-5 dark:text-white">10</p>
                    <!-- <hr > -->
                </div>
            </div>
            <!-- /Cards -->
            ...
            <div class="container mx-auto pr-4">
                <div class="w-72 bg-white dark:bg-gray-900 max-w-xs mx-auto rounded-sm overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-100 cursor-pointer">
                    <div class="h-20 bg-blue-500 flex items-center justify-between">
                        <p class="mr-0 text-white text-lg pl-5">Reservaciones</p>
                    </div>
                    <div class="flex justify-between px-5 pt-6 mb-2 text-sm dark:text-gray-300 text-gray-600">
                        <p>TOTAL</p>
                    </div>
        ...
        <!-- /Stats -->
        <div class="hidden grid grid-cols-1 gap-2 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 mt-3 p-4">
