...
<template>
    <div>
        <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
            ...
            <div class="text-white overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 cursor-pointer">
                    <thead>
                        <tr>
                            <th class="px-4 py-3.5 font-bold text-left text-gray-500 dark:text-gray-400">Folio</th>
                            <th class="px-4 py-3.5 font-bold text-left text-gray-500 dark:text-gray-400">Huesped</th>
                            <th class="px-4 py-3.5 font-bold text-left text-gray-500 dark:text-gray-400">Llegada</th>
                            <th class="px-4 py-3.5 font-bold text-left text-gray-500 dark:text-gray-400">Habitación</th>
