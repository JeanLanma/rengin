...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title inertia>{{ config('app.name', 'Rengin') }} @yield('title')</title>
            ...
            <nav class="bg-white border-b border-[#5e6c2c]">
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <a :href="route('booking')" :active="route().current('booking')">
                            Reservar
                        </a>
                        <a :href="route('direct-booking.policies')" :active="route().current('direct-booking.policies')">
                            Politicas
                        </a>
                    </div>
